...
data class User(
    ...
    @SerializedName("private_gists") var privateGists: Int = 0,
    @SerializedName("total_private_repos") var totalPrivateRepos: Int = 0,
    @SerializedName("owned_private_repos") var ownedPrivateRepos: Int = 0,
    @SerializedName("disk_usage") var disk_usage: Int = 0,
    @SerializedName("collaborators") var collaborators: Int = 0,
    @SerializedName("two_factor_authentication") var twoFactorAuthentication: Boolean = false,
